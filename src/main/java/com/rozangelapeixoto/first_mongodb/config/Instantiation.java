package com.rozangelapeixoto.first_mongodb.config;

import com.rozangelapeixoto.first_mongodb.domain.Post;
import com.rozangelapeixoto.first_mongodb.domain.User;
import com.rozangelapeixoto.first_mongodb.dto.AuthorDTO;
import com.rozangelapeixoto.first_mongodb.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        CommentDTO c2 = new CommentDTO("Apoveite", sdf.parse("22/03/2018"), new AuthorDTO(bob));
